...
if ('\Desktop App\ELECTRON-4-PHP\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('\Desktop App\ELECTRON-4-PHP\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
